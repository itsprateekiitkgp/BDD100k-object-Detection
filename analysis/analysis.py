...
class BDD100KParser:
    def __init__(self, base_path):
        ...
        self.images_path = os.path.join(base_path, "bdd100k_images_100k/bdd100k/images", "100k")
        self.labels_path = os.path.join(base_path, "bdd100k_labels_release/bdd100k", "labels")
        self.train_json = os.path.join(self.labels_path, "bdd100k_labels_images_train.json")
        ...
        # Define class names
        self.class_names = ["car", "traffic sign", "traffic light", "person", 
...
if __name__ == "__main__":
    ...
    plt.bar(train_class_dist.keys(), [train_class_dist[k] for k in train_class_dist.keys()])
